...
Resposta (JSON):
Retorna o valor em gramas de proteína.
...
Resposta (JSON):
Retorna as calorias que seu corpo precisa por dia.
...
Resposta (JSON):
Retorna suas calorias de acordo com sua frequência física.
...
Resposta (JSON):
Retorna o valor em gramas de gordura por dia de acordo com o objetivo.
